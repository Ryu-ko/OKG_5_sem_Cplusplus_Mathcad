...
// содержит реализацию класса CMatrix, который представляет матрицу и реализует различные операции с матрицами, такие как сложение, вычитание, умножение и другие.
// Также в этом файле есть методы для доступа к элементам матрицы и другие операции, такие как нахождение максимального и минимального элементов.
...
{	
	...
	if(!bb)
	{ 
		char* error="CMatrix::operator(-): неверные входные данные";
		MessageBoxA(NULL,error,"Error",MB_ICONSTOP);
    exit(1);
	}
	CMatrix Temp(*this);
